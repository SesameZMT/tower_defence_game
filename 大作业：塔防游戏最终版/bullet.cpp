...
Bullet::Bullet(QPoint startPos,QPoint targetPos,int damage,QPointer<Enemy> targetEnemy,MainWindow * game,QString path):
    m_startPos(startPos),
...
{
    painter->drawPixmap(m_currentPos.x(), m_currentPos.y(), m_fixedSize.width(), m_fixedSize.height(),m_path);
}
